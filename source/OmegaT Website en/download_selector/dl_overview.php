...
<p>Platform-specific versions of OmegaT are provided for Windows, Linux and Mac OS X. A platform-independent version is also available which will run on any operating system capable of running a suitable version of the Java Runtime Environment.</p>
